...
namespace Knights.Foundation.KeywordFieldHelper.Services
{
    public static class ServiceCollectionExtensions
    {
        ...
        public static void AddMvcControllers(this IServiceCollection serviceCollection, params Assembly[] assemblies)
        {
            ...
            foreach (var controller in controllers) serviceCollection.AddTransient(controller);
            ...
            foreach (var apiController in apiControllers) serviceCollection.AddTransient(apiController);
        }
